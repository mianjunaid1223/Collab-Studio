...
export default async function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <section className="w-full pt-20 md:pt-32 lg:pt-40 pb-10 md:pb-16 lg:pb-20 bg-gradient-to-b from-background to-secondary/20">
        <div className="container px-4 md:px-6">
          <div className="grid gap-8 lg:grid-cols-2 lg:gap-16 items-center">
            <div className="flex flex-col justify-center space-y-6">
              <div className="space-y-4">
                ...
                <p className="max-w-[600px] text-muted-foreground text-lg md:text-xl font-body">
                  Collab Canvas is a digital mindfulness and teamwork tool. Create beautiful art together, one contribution at a time.
                </p>
              </div>
            ...
            <Image
              ...
              height="400"
              alt="Hero"
              className="mx-auto aspect-video overflow-hidden rounded-xl object-cover sm:w-full border shadow-2xl shadow-primary/10"
            />
          </div>
        </div>
      </section>
      ...
      <section className="w-full py-16 md:py-24 lg:py-32">
        <div className="container px-4 md:px-6">
          ...
          <div className="mx-auto grid max-w-5xl items-start gap-8 sm:grid-cols-2 md:gap-12 lg:grid-cols-3 lg:max-w-none mt-12">
            <Card className="bg-card/80 border-2 border-transparent hover:border-primary/50 transition-all duration-300 transform hover:-translate-y-1 p-6 text-center">
      ...
      <section className="w-full py-16 md:py-24 lg:py-32 bg-secondary/50">
        <div className="container grid items-center justify-center gap-4 px-4 text-center md:px-6">
          ...
          {completedProjects.length > 0 ? (
            ...
            <p className="text-muted-foreground col-span-full text-center py-8">No masterpieces have been completed yet.</p>
          )}
        </div>
      </section>
    </div>
